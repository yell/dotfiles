...
\usepackage[activate={true,nocompatibility},
            ...
            factor=1100,
            stretch=10,
            shrink=10]{microtype}  % microtypography, improves general appearance
...
\usepackage{enumitem}  % much easier to modify lists, e.g. `noitemsep`
...
\usepackage[linktocpage,
            colorlinks=true,
            bookmarksnumbered=true]{hyperref}  % hyperlinks
